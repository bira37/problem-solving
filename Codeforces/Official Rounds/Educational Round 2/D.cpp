...
struct Geo2D {
  ...
  double circleCircleIntersection(Circle c1, Circle c2){
    ...
    const double r1sqr = c1.r*c1.r;
    const double r2sqr = c2.r*c2.r;
...
int32_t main() {
  ...
  Circle c1(Point2D(x1, y1), r1);
  Circle c2(Point2D(x2, y2), r2);
  
  cout << geo2d.circleCircleIntersection(c1, c2) << endl;
}
